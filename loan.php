<?php 
	...
	$q = "SELECT * FROM loan, cms,group_members,tenants WHERE group_members.fk_tenant_id = tenants.tenant_id AND group_members. cms.status='active' ORDER BY loan_id DESC";
	...
	<th width="17%" align="left">Loan Amount</th>
	<th width="22%" align="left">Amount paid</th>
	<th width="36%" align="left">Pending payment</th>
	<th width="36%" align="left">Amount paid(required)</th>
	<th width="36%" align="left">Penalty</th>';
